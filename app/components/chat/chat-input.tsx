        ...
        <form onSubmit={handleSubmit} className="flex items-end gap-2 p-4">
          <div className="flex-1 relative">
            <Textarea
              ...
              disabled={disabled}
              className="min-h-[60px] max-h-[160px] resize-none border-0 !bg-card focus-visible:ring-0 focus-visible:ring-offset-0 focus:outline-none text-base leading-relaxed p-0 placeholder:text-muted-foreground shadow-none"
              rows={1}
              ref={textareaRef}
              autoFocus
            />
